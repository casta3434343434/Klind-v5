...
// Ogni grado King Rock copre più gradi Font: le due tabelle sotto NON sono
// più usate per salvare i blocchi (un blocco registrato in scala King ora
// salva l'ID King direttamente — vedi tapGrades/DisciplineFields.svelte),
// ma restano necessarie per due cose: (1) mostrare un grado King quando
// l'utente preferisce vedere in un'altra scala (Font/Francese/ecc — vedi
// displayGrade), e (2) leggere le sessioni vecchie salvate prima di questa
// correzione, che avevano il grado già convertito in Font.
...
export const KING_TO_FONT = { '1':'4', '2':'5', '2+':'5+', '3':'6A', '3+':'6A', '4':'6A+', '4+':'6B+', '5':'6C+', '5+':'7A+', '6+':'7B+', '6-':'7C', '7':'7C+' };
